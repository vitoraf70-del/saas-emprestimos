...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-size:2.25rem] sm:[--cell-size:2.5rem] [[data-slot=popover-content]_&]:bg-transparent [[data-slot=card-content]_&]:bg-transparent",
      ...
      formatters={{
        formatCaption: (month, _options, _dateLib) => format(month, "LLLL yyyy", { locale: ptBR }),
        formatMonthDropdown: (date) => format(date, "LLLL", { locale: ptBR }),
        ...formatters
      }}
      classNames={{
